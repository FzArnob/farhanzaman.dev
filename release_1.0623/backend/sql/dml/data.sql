...
VALUES ('farhan', 'Farhan Zaman', 'Farhan', 'Zaman', 'Arnob', 'Sr.Software Engineer,AI Researcher,Art Enthusiast', 'I am all about tackling challenges head-on and finding creative solutions! Whether a complex issue or a simple puzzle, count me in. Know more about me below.', 'From a young age, my curiosity for technology and mathematics has been the driving force that led me to the world of programming and problem-solving, where challenges fuel my passion. I have strong programming skills and experience in Machine Learning and Artificial Intelligence, Image processing, contributing to research in Human Posture Classification. As a Sr.software engineer, I aspire to fuse AI and Computer Vision into the software industry, anticipating a future where AI revolutionizes software solutions. Beyond tech,I indulge in arts, digital arts, and photography. In college, I took on the role of General Secretary forthe Dhaka College Science Club (DCSC), organizing science fairs, while in university, I passionatelycontributed to impactful social initiatives as a Sr. Executive of the Brac University Community ServiceClub (BUCSC).',
        ...
        'Dhaka, Bangladesh -1205', '(+880) 1521581368', '9876543210', 'farhanzamanarnob@gmail.com',
