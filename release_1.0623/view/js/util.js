...
if (getCookie("theme") === "") {
  ...
  document
    ...
    .insertAdjacentHTML(
      "beforeend",
      `<link type="text/css" rel="stylesheet" href="https://cdn.jsdelivr.net/gh/FzArnob/farhanzaman.dev@main/release_1.0623/view/css/theme/dark.css" data-theme="dark" />`
    );
  ...
  document
    ...
    .insertAdjacentHTML(
      "beforeend",
      `<link type="text/css" rel="stylesheet" href="https://cdn.jsdelivr.net/gh/FzArnob/farhanzaman.dev@main/release_1.0623/view/css/theme/light.css" data-theme="light" />`
    );
}

//theme toogle
themeButton = document.querySelector("#theme-toogle-button");
if (themeButton) {
...
//nav toogle
navToogle = document.querySelector("#nav-menu-button");
if (navToogle) {
