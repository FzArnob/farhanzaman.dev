...
VALUES 
('HTML', 'The fundamental language for structuring web content and defining page layouts. Employed extensively in projects like CovidEase and Tribel, forming the cornerstone of user interfaces.', 60, 'Beginner', 'farhan'),
('CSS', 'Cascading Style Sheets used to define the presentation of web documents. Implemented in Tribel and CovidEase for precise and elegant visual designs.', 60, 'Beginner', 'farhan'),
('JavaScript', 'A scripting language essential for dynamic client-side functionalities. Utilized in Space Ninja and Tribel for interactive user experiences and real-time updates.', 90, 'Intermediate', 'farhan'),
('TypeScript', 'A typed superset of JavaScript, enhancing code reliability and scalability. Complements JavaScript in evolving applications for improved robustness.', 60, 'Intermediate', 'farhan'),
('Python', 'A versatile language applied in Simba (CSA) for refining AI models and handling complex data manipulation tasks.', 120, 'Intermediate', 'farhan'),
('Java', 'An object-oriented programming language crucial for building robust backend systems. Integral in projects like Pocketalk Ventana, CovidEase, and the C Academy TMS.', 120, 'Intermediate', 'farhan'),
('Java EE', 'A platform for enterprise-grade Java applications. Employed in projects like Pocketalk Ventana for scalable and secure backend solutions.', 90, 'Intermediate', 'farhan'),
('PHP', 'A server-side scripting language pivotal in projects such as CovidEase for data scraping and backend operations.', 90, 'Intermediate', 'farhan'),
('SpringBoot', 'A Java-based framework enabling rapid development of production-ready applications. Deployed in Pocketalk Ventana for efficient backend processes.', 90, 'Intermediate', 'farhan'),
('ReactJS', 'A JavaScript library for building user interfaces. Utilized in Tribel and the C Academy TMS for crafting responsive and interactive frontend experiences.', 120, 'Advanced', 'farhan'),
('MongoDB', 'A NoSQL database system providing flexible and scalable data storage. Integrated into projects like Tribel and CovidEase for managing dynamic data sets.', 90, 'Intermediate', 'farhan'),
('NodeJS', 'A JavaScript runtime enabling server-side execution. Integral in projects like Tribel for backend operations and server-side scripting.', 90, 'Intermediate', 'farhan'),
('MySQL', 'A relational database management system used in projects such as Pocketalk Ventana and Tribel for efficient data storage and retrieval.', 90, 'Intermediate', 'farhan'),
('NoSQL', 'A database management system employed in Pocketalk Ventana for flexible and scalable data handling.', 60, 'Intermediate', 'farhan'),
('GraphQL', 'A query language for APIs facilitating efficient data retrieval. Applied in Tribel for streamlined data querying and real-time synchronization.', 60, 'Beginner', 'farhan'),
('Selenium', 'An automation tool for web browser testing. Employed behind the scenes to ensure seamless browser automations.', 60, 'Beginner', 'farhan'),
('OOP', 'Object-Oriented Programming paradigm serving as the foundation for scalable and maintainable code architectures.', 90, 'Intermediate', 'farhan'),
('Redux', 'A state management library for JavaScript applications. Utilized in Tribel for managing application state and data flow.', 60, 'Intermediate', 'farhan'),
('jQuery', 'A fast and feature-rich JavaScript library for simplifying HTML document traversal and manipulation. Used in Space Ninja for streamlined document operations.', 60, 'Beginner', 'farhan'),
('Photoshop', 'A raster graphics editor instrumental in crafting visual elements for projects like Tribel, ensuring pixel-perfect designs.', 90, 'Intermediate', 'farhan'),
('Illustrator', 'A vector graphics editor contributing to scalable visuals in projects like Tribel, ensuring visually consistent and scalable designs.', 90, 'Intermediate', 'farhan'),
('Excel', 'A spreadsheet program used for harmonizing and organizing data sets in various project contexts.', 60, 'Beginner', 'farhan'),
('PowerPoint', 'A presentation software used for visual storytelling and crafting impactful narratives in project presentations.', 60, 'Beginner', 'farhan');
