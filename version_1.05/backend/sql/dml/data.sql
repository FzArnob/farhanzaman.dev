...
VALUES 
('HTML', 'Fundamental for web structuring and layouts. Used in CovidEase and Tribel.', 60, 'Beginner', 'farhan'),
('CSS', 'Defines web document presentation. Implemented in Tribel and CovidEase.', 60, 'Beginner', 'farhan'),
('JavaScript', 'Essential for dynamic client-side functionalities. Used in Space Ninja and Tribel.', 90, 'Intermediate', 'farhan'),
('TypeScript', 'Typed superset of JavaScript for code reliability. Complements JavaScript.', 60, 'Intermediate', 'farhan'),
('Python', 'Versatile language used in Simba (CSA) for AI models and data tasks.', 120, 'Intermediate', 'farhan'),
('Java', 'Crucial for robust backend systems. Integral in Pocketalk Ventana, CovidEase, and C Academy TMS.', 120, 'Intermediate', 'farhan'),
('Java EE', 'Enterprise-grade Java applications. Employed in Pocketalk Ventana.', 90, 'Intermediate', 'farhan'),
('PHP', 'Pivotal for backend operations in CovidEase and Examiner.', 90, 'Intermediate', 'farhan'),
('SpringBoot', 'Enables rapid development of production-ready apps. Deployed in Pocketalk Ventana.', 90, 'Intermediate', 'farhan'),
('ReactJS', 'Builds UI in Tribel and C Academy TMS for responsiveness.', 120, 'Advanced', 'farhan'),
('MongoDB', 'Flexible data storage in multiple projects.', 90, 'Intermediate', 'farhan'),
('NodeJS', 'Enables server-side execution in Tribel.', 90, 'Intermediate', 'farhan'),
('MySQL', 'Efficient data storage in Pocketalk Ventana, Examiner and Tribel.', 90, 'Intermediate', 'farhan'),
('NoSQL', 'Flexible data handling in Pocketalk Ventana.', 60, 'Intermediate', 'farhan'),
('GraphQL', 'Facilitates efficient data retrieval in Tribel.', 60, 'Beginner', 'farhan'),
('Selenium', 'Automation tool for web browser testing.', 60, 'Beginner', 'farhan'),
('OOP', 'Foundation for scalable code architectures.', 90, 'Intermediate', 'farhan'),
('Redux', 'Manages app state and data flow in Tribel.', 60, 'Intermediate', 'farhan'),
('jQuery', 'Simplifies HTML document manipulation in Space Ninja.', 60, 'Beginner', 'farhan'),
('Photoshop', 'Crafts visuals for CovidEase ensuring pixel-perfect designs.', 90, 'Intermediate', 'farhan'),
('Illustrator', 'Contributes to scalable visuals in Space Ninja.', 90, 'Intermediate', 'farhan'),
('Excel', 'Harmonizes and organizes data sets in various projects.', 60, 'Beginner', 'farhan'),
('PowerPoint', 'Crafts impactful narratives in project presentations.', 60, 'Beginner', 'farhan');
