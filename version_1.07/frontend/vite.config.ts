...
/** Shared data folder: version_1.07/data — the single source of truth for profile + gaming JSON. */
const dataDir = resolve(here, '../data');

/**
 * Serves version_1.07/data at /data during `vite dev`, and copies it into
