    ...
    return array(
        ...
        'projects' => array(
            ...
            'fields' => array(
                ...
                array('name' => 'logo', 'label' => 'Logo URL', 'type' => 'url', 'width' => 'half', 'help' => 'A transparent PNG or SVG — just the mark, no background. It is held inside the project\'s crystal. Left empty, the crystal shows the project\'s initials.'),
                array('name' => 'theme_color', 'label' => 'Theme colour', 'type' => 'color', 'width' => 'half', 'help' => 'The brand colour, as #rrggbb. The crystal is cut from glass of this colour, and the flat site\'s card sits on it.'),
